...
if xrandr | grep "HDMI-2 disconnected"; then
	...
	xmodmap ~/.Xmod_left
	xrandr --output VGA-1 --off --output LVDS-1 --off --output HDMI-3 --off --output HDMI-2 --mode 1920x1080 --rotate normal --output HDMI-1 --off --output DP-3 --off --output DP-2 --off --output DP-1 --off
fi
